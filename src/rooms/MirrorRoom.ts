...
const room: RoomDef = {
  ...
  description: 'Зеркала повсюду. Каждое показывает другую.',
  width: 7,
  height: 7,
  tileColors: [
    [5, 5, 5, 5, 5, 5, 5],
  ...
  hotspots: [
    { x: 3, y: 1, width: 1, height: 1, label: 'Стена зеркал', action: 'mirror_wall' },
    { x: 1, y: 3, width: 1, height: 1, label: 'Разбитое зеркало', action: 'mirror_broken' },
    ...
    { x: 4, y: 4, width: 1, height: 1, label: 'Надпись: «КТО ПОМНИТ ПРАВИЛЬНО?»' },
  ],
  npcs: [],
